...
public class Ribcage extends AppCompatActivity {
    ImageView imageView;
    MediaPlayer mm;
    ImageButton btn1;
    TextView output;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final Dialog dialog = new Dialog(Ribcage.this);
        ...
        mm= MediaPlayer.create(Ribcage.this,R.raw.backgroundmusic);
        mm.start();
        BufferedReader reader = null;

        try {
            reader = new BufferedReader(
                    new InputStreamReader(getAssets().open("Ribcage.txt")));
