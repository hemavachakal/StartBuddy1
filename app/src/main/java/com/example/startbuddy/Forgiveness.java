    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final Dialog dialog = new Dialog(Forgiveness.this);
        ...
        mm= MediaPlayer.create(Forgiveness.this,R.raw.backgroundmusic);
        mm.start();
        BufferedReader reader = null;

        try {
            reader = new BufferedReader(
                    new InputStreamReader(getAssets().open("Forgiveness Meditation.txt")));
